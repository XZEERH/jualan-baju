  ...
  return (
    <div className="relative h-screen w-full flex items-center justify-center bg-white px-6">
      <div className="text-center fade-in">
        <span className="font-signature text-3xl md:text-5xl text-gray-700 block mb-4">Rama Shop</span>
        <h1 className="text-6xl md:text-9xl font-bold tracking-tighter mb-10 leading-[0.9]">
