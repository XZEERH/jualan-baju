    ...
    <nav className="fixed top-0 w-full z-[100] bg-white/90 backdrop-blur-md border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-5">
          <a href="#shop" className="hover:opacity-50 transition"><ShoppingBag className="w-5 h-5" /></a>
      ...
      {isOpen && (
        <div className="fixed inset-0 top-16 bg-white z-[99] flex flex-col items-center pt-20 space-y-8 text-xs font-bold uppercase tracking-[0.3em] fade-in md:hidden">
